...
- [x] `DONE` Provider-neutral supplier payout adapter boundary + sandbox payout flow
- [ ] `NEXT` Live provider payout integration, settlement retries and reconciliation operations
